...
const memes = [
    ...
    "Почему ты еще не на работе? Кто будет зарабатывать мне на паштет?",
    "Ты думаешь, я сплю? Я скачиваю обновления для ночного ора.",
    "Если я поместился в коробку, значит, я в домике. А ты — в ипотеке.",
    "Мой девиз: Поспи сегодня. Поспи завтра. Поспи вообще.",
    "Твои комнатные растения были невкусными. Больше не покупай.",
    "Жизнь коротка. Спи 20 часов в сутки.",
    "Если я сижу на тебе — ты не имеешь права двигаться по закону физики.",
    "Собака: «Он меня кормит, он Бог!». Кот: «Он меня кормит, я Бог!».",
    "Пылесос — это порождение сатаны. Унеси его немедленно.",
    "Я не крал колбасу. Я спас её от твоего ожирения.",
    "Твой будильник бесполезен. Я начинаю орать за 5 минут до него.",
    "Ты со мной разговариваешь? Принеси лучше валерьянку.",
    "Если бы у котов был интернет, там были бы только фото спящих людей.",
    "Твой палец выглядит как сосиска. Не вини меня.",
    "Сбросил телефон со стола. Гравитация всё еще работает, проверял.",
    "Твои новые тапки пахли скучно. Теперь они пахнут приключениями.",
    "Я не прячусь в шкафу. Я здесь работаю министром внутренних дел.",
    "Ты завел собаку? Что ж, я всегда хотел попрактиковаться в экзорцизме.",
    "Когда-нибудь я научусь пользоваться твоей кредиткой. Тогда ты мне станешь не нужен.",
    "Если ты внезапно исчезнешь, я расстроюсь. Дверь в холодильник сама не откроется."
    ];
